...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        dialog.show();
        if (intent.hasExtra("content")) {
            TxTTS.getInstance(null).talkWithoutDisplay(context.getString(R.string.str_alarm_note) + intent.getStringExtra("content"));
        } else {
            TxTTS.getInstance(null).talkWithoutDisplay(context.getString(R.string.str_alarm_note));
        }
